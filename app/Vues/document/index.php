...
<body class="bg-background-dark text-slate-100 antialiased h-screen flex flex-col overflow-hidden">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <aside class="hidden md:flex w-20 bg-slate-900 border-r border-dark-border flex-col items-center py-6 shrink-0">
            ...
            <nav class="flex-1 flex flex-col gap-4">
                ...
                <a class="w-12 h-12 flex items-center justify-center rounded-xl bg-primary/10 text-primary transition-all group relative" href="/documents" title="Documents">
    ...
    <script src="<?= asset('js/document/modal.js') ?>"></script>
    <script src="<?= asset('js/document/app.js') ?>"></script>
</body>
