<section class="px-4 py-8 sm:px-8">
    ...
    <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-8">
        ...
        <button @click="openInvitationModal()" class="h-11 px-6 bg-primary hover:bg-primary-container dark:bg-primary-fixed dark:hover:bg-primary-fixed/90 text-on-primary dark:text-on-primary-fixed rounded-xl font-semibold text-sm flex items-center justify-center gap-2 transition-colors shadow-lg shadow-primary/20 dark:shadow-primary/10" id="btnInviteUser" @click="openInvitationModal()">
    ...
    <div x-data="inviteUserModal()">
        ...
        <div x-show="opened"
            ...
            <!-- Modal -->
            <div class="w-full max-w-lg rounded-2xl bg-white dark:bg-gray-900 shadow-xl p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="text-sm text-gray-600 dark:text-gray-300">Rôle</label>
                        <select x-model="role"
                            class="w-full mt-1 px-3 py-2 rounded-lg border
                               bg-white dark:bg-gray-800
                               text-gray-800 dark:text-white
    ...
    <div x-data="createRoleModal()">
        ...
        <div x-show="opened"
            ...
            <!-- Modal -->
            <div class="w-full max-w-xl rounded-2xl bg-white dark:bg-gray-900 shadow-xl p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="text-sm text-gray-600 dark:text-gray-300">Nom du rôle</label>
                        <input type="text"
                            x-model="name"
                            placeholder="ex: Manager Stock"
                            class="w-full mt-1 px-3 py-2 rounded-lg border
                               bg-white dark:bg-gray-800
                               text-gray-800 dark:text-white
                               border-gray-300 dark:border-gray-700
                    ...
                    <div>
                        <label class="text-sm text-gray-600 dark:text-gray-300">Code</label>
                        <input type="text"
                            x-model="code"
                    ...
                    <!-- Permissions (simple UI) -->
                    <div>
                        <label class="text-sm text-gray-600 dark:text-gray-300">
                            Permissions
                        </label>

                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-2 max-h-48 overflow-y-auto">

                            <template x-for="perm in permissions" :key="perm.code">
                                <label class="flex items-center gap-2 p-2 rounded-lg border
    ...
    <script>
        window.inviteUserModal = function() {
            return {
                opened: false,
                email: '',
                role: 'employee',
        ...
        window.openInvitationModal = function() {
            return inviteUserModal.open()
        }
        window.createRoleModal = function() {
            return {
                opened: false,
                name: '',
                code: '',
