        ...
        <div class="w-full max-w-4xl">
            ...
            <div class="grid md:grid-cols-2 gap-8 lg:gap-12">
                ...
                <div class="space-y-8 animate-fade-in-up" style="animation-delay: 0.2s;">
                    ...
                    <button
                        id="startWizardBtn"
                        class=" hidden w-full bg-primary hover:bg-primary-dark text-on-surface font-bold py-4 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-3 group shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 active:scale-95">
                    ...
                    <button
                        ...
                        <span class="text-lg">Initialisation du wizard...</span>
